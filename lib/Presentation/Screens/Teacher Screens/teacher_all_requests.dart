    ...
    await FirebaseFirestore.instance.collection(teachersCollection).doc(current_user!.uid).collection("Requests").doc("${requestType}").collection(accountTypes[requestType]).get().then(
          ...
          setState(() {
            ...
            value.docs.forEach((element) {
              ...
              requests.add(Request(id:element.id, name: element.data()['name'], groupId: element.data()['groupId'], isPending: element.data()['isPending'], userId: element.data()['userId']));
              ...
              Row(
                children: [
                  requestButton(text: "Accept", tap: (){
                    ...
                    FirebaseFirestore.instance.collection(teachersCollection).doc(current_user!.uid).collection(teacherRequestsCollection).doc(requestModel.id).delete().then((value) {
                      setState(() {
