...
class EditGroupDetails extends StatefulWidget {
  const EditGroupDetails({super.key, required this.groupId});
...
class _EditGroupDetailsState extends State<EditGroupDetails> {
  ...
  void editGroup() {
    if (formKey.currentState!.validate()) {
      ...
      FirebaseFirestore.instance.collection(groupsCollection).doc(widget.groupId).update({
                ...
                Row(
                  ...
                  children: [
                    ...
                    Center(
                      child: GestureDetector(
                        onTap: () {
                          FirebaseFirestore.instance.collection(groupsCollection).doc(widget.groupId).delete();
                        },
                        child: Container(
                          height: h / 13.75,
                          width: w / 4,
